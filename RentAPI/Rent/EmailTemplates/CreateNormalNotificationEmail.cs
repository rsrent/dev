...
{
    public class CreateNormalNotificationEmail
    {
        public static BodyBuilder Build(string header, string body)
        {
                            ...
                            <tr>
                                <td>
                                    <table width='100%' border='0' cellspacing='0' cellpadding='0'>
                                        ...
                                        <tr>
                                            <td align='center' style='padding: 20px 100px 0 100px; font-size: 16px; line-height: 25px; font-family: Helvetica, Arial, sans-serif; color: #666666;' class='padding'>For mere information gå til web-appen. Der vil du kunne finde information om din rengøringsaftale, kvalitetsrapporter, vigtige dokumenter. Her kan du også se personalet der gør rent hos dig. Du kan altid kontakte os hvis du har nogen spørgsmål</td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
