...
namespace Rent.Repositories
{
    public class CustomerRepository
    {
        ...
        public async Task<dynamic> Create(int requester, Customer newCustomer)
        {
            ...
            return (await _customerContext.Create(requester, customer)).Detailed();
        }

        public async Task Update(int requester, Customer updateCustomer)
        {
            Console.WriteLine(updateCustomer == null);
            Console.WriteLine(updateCustomer);

            int id = updateCustomer.ID;

            await _customerContext.Update(requester, c => c.ID == id, c =>
            {
