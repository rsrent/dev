...
namespace Rent.Controllers
{
    ...
    public class CleaningTaskController : ControllerExecutor
    {
        ...
        public CleaningTaskController(/*RentContext context, NotificationRepository notificationRepository, PermissionRepository permissionRepository, */CleaningTaskRepository cleaningTaskRepository)
        {
            //_context = context;
