...
namespace Rent.Controllers
{
    ...
    public class LogController : Controller
    {
        ...
        {
            var log = new LocationLog { UserID = UserID, LocationID = locationID, DateCreated = DateTimeHelpers.GmtPlusOneDateTime(), Log = "", Title = "", CustomerCreated = false };
        ...
        [HttpGet("{logID}")]
        [Authorize]
        public IActionResult Get([FromRoute] int logID)
        {
