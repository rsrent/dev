...
namespace Rent.Models
{
    public class CleaningTaskCompleted
    {
        ...
        public static Expression<Func<CleaningTaskCompleted, dynamic>> BasicDTO(int requester, string requesterRole)
        {
            return v => v != null ?
            new
            {
                ...
                v.Comment,
                v.CompletedDate,
                CompletedByUser = User.BasicDTO().Compile()(v.CompletedByUser),
            } : null;
        }
    }
