...
namespace Rent.Controllers
{
    ...
    public class LocationController : ControllerExecutor
    {
        ...
        public async Task<IActionResult> Update(int locationId, [FromBody] Location updatedLocation)
        => await Executor(async () => await _locationRepository.Update(Requester, locationId, updatedLocation));
