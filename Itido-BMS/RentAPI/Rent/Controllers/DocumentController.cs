...
namespace Rent.Controllers
{
    ...
    public class DocumentController : Controller
    {
        ...
        [HttpGet("GetOfFolder/{folderID}")]
        [Authorize]
        public IActionResult GetOfFolder([FromRoute] int folderID)
        {

            return Ok(_documentRepository.GetOfFolder(UserID, folderID));
        }
        /*
        ...
        */
        ...
        {
            return Ok(_documentRepository.GetOfProjectItem(UserID, projectItemId));
        }

        [HttpPost("AddDocumentToFolder/{folderID}")]
        [Authorize]
        public async Task<IActionResult> AddDocumentToFolder([FromRoute] int folderID, [FromBody] Document document)
        {
            return Ok(await _documentRepository.AddDocumentToFolder(UserID, folderID, document));
        }

        [HttpPost("AddFolderToFolder/{folderID}/{title}")]
        [Authorize]
        public async Task<IActionResult> AddFolderToFolder([FromRoute] int folderID, [FromRoute] string title)
        {
            return Ok(await _documentRepository.AddFolderToFolder(UserID, folderID, title));
        }

        [HttpGet("GetDocumentsOfFolder/{folderId}")]
        [Authorize]
        public IActionResult GetDocumentsOfFolder([FromRoute] int folderId)
        {
            return Ok(_documentRepository.GetDocumentsOfFolder(UserID, folderId));
        }
        ...
        public IActionResult GetRoots()
        {
            ...
            return Ok(_documentRepository.GetRoots());
        }
    }
}
