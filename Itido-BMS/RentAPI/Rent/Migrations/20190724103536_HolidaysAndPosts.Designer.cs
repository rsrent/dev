...
namespace Rent.Migrations
{
    ...
    [Migration("20190724103536_HolidaysAndPosts")]
    partial class HolidaysAndPosts
    {
            ...
            modelBuilder.Entity("Rent.Models.TimePlanning.Work", b =>
                {
                    ...
                    b.Property<int?>("ContractAgreementID");

                    b.Property<int?>("ContractID");

                    b.Property<int?>("ContractUserID");
                    ...
                    b.Property<int?>("WorkRegistrationID");

                    b.Property<int?>("WorkReplacementID");

                    b.HasKey("ID");

                    b.HasIndex("LocationID");

                    b.HasIndex("WorkRegistrationID");

                    b.HasIndex("WorkReplacementID");

                    b.HasIndex("ContractAgreementID", "ContractUserID");
            ...
            modelBuilder.Entity("Rent.Models.TimePlanning.Work", b =>
                {
                    ...
                    b.HasOne("Rent.Models.TimePlanning.WorkRegistration", "WorkRegistration")
                        .WithMany()
                        .HasForeignKey("WorkRegistrationID");

                    b.HasOne("Rent.Models.TimePlanning.WorkReplacement", "WorkReplacement")
                        .WithMany()
                        .HasForeignKey("WorkReplacementID");

                    b.HasOne("Rent.Models.TimePlanning.Contract", "Contract")
                        .WithMany()
                        .HasForeignKey("ContractAgreementID", "ContractUserID");
                });
