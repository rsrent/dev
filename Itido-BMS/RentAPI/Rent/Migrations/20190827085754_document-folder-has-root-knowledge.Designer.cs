...
namespace Rent.Migrations
{
    ...
    [Migration("20190827085754_document-folder-has-root-knowledge")]
    partial class documentfolderhasrootknowledge
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Rent.Models.Test.Client", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Rent.Models.Test.Division", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Rent.Models.Test.DivisionUser", b =>
                {
            ...
            modelBuilder.Entity("Rent.Models.Test.Unit", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<string>("EconomyAccess")
                        .HasMaxLength(10);

                    b.Property<string>("HourAccess")
                        .HasMaxLength(10);

                    b.Property<string>("LogAccess")
                        .HasMaxLength(10);

                    b.Property<int?>("ParentID");

                    b.Property<string>("ReportAccess")
                        .HasMaxLength(10);

                    b.Property<string>("ShiftAccess")
                        .HasMaxLength(10);

                    b.Property<string>("TaskAccess")
                        .HasMaxLength(10);
            ...
            modelBuilder.Entity("Rent.Models.Test.UnitUser", b =>
                {
                    b.Property<int>("UnitID");
            ...
            modelBuilder.Entity("Rent.Models.Location", b =>
                {
                    ...
                    b.HasOne("Rent.Models.Test.Unit", "Unit")
                        .WithMany()
            ...
            modelBuilder.Entity("Rent.Models.Test.DivisionUser", b =>
                {
                    b.HasOne("Rent.Models.Test.Division", "Division")
            ...
            modelBuilder.Entity("Rent.Models.Test.Unit", b =>
                {
                    b.HasOne("Rent.Models.Test.Division")
                        .WithMany("Units")
                        .HasForeignKey("DivisionID");

                    b.HasOne("Rent.Models.Test.Unit", "Parent")
                        .WithMany("Children")
                        .HasForeignKey("ParentID");
                });
