...
namespace Rent.Migrations
{
    ...
    [Migration("20180715153813_AddDiscriminator")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Rent.Models.CleaningTask+DB", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Rent.Models.CleaningTaskCompleted+DB", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Rent.Models.Customer+DB", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Rent.Models.LocationCleaningPlanDocument", b =>
                {
                    b.Property<int>("CleaningPlanID");
                    ...
                    b.HasKey("CleaningPlanID", "DocumentFolderID", "LocationID");

                    b.HasIndex("DocumentFolderID");

                    b.HasIndex("LocationID");

                    b.ToTable("LocationCleaningPlanDocument");
                });
            ...
            modelBuilder.Entity("Rent.Models.LocationUser+DB", b =>
                {
                    b.Property<int>("LocationID");
            ...
            modelBuilder.Entity("Rent.Models.User+DB", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Rent.Models.Location+DB", b =>
                {
                    b.HasBaseType("Rent.Models.Location");
                    ...
                    b.HasDiscriminator().HasValue("DB");
                });
            ...
            modelBuilder.Entity("Rent.Models.CleaningTask+DB", b =>
                {
                    ...
                    b.HasOne("Rent.Models.Location+DB", "Location")
                        .WithMany()
                        .HasForeignKey("LocationID")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Rent.Models.User+DB", "UserResposible")
                        .WithMany()
            ...
            modelBuilder.Entity("Rent.Models.CleaningTaskCompleted+DB", b =>
                {
                    b.HasOne("Rent.Models.CleaningTask+DB", "CleaningTask")
                        .WithMany("CompletedTasks")
                        .HasForeignKey("CleaningTaskID")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Rent.Models.User+DB", "CompletedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Rent.Models.ConversationUsers", b =>
                {
                    ...
                    b.HasOne("Rent.Models.User+DB", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Rent.Models.Customer+DB", b =>
                {
                    ...
                    b.HasOne("Rent.Models.User+DB", "KeyAccountManager")
                        .WithMany()
                        .HasForeignKey("KeyAccountManagerID");

                    b.HasOne("Rent.Models.User+DB", "MainUser")
                        .WithMany()
                    ...
                    b.HasOne("Rent.Models.User+DB", "SalesRep")
                        .WithMany()
            ...
            modelBuilder.Entity("Rent.Models.User+DB", b =>
                {
                    b.HasOne("Rent.Models.Customer+DB", "Customer")
                        .WithMany("Users")
            ...
            modelBuilder.Entity("Rent.Models.Location+DB", b =>
                {
                    ...
                    b.HasOne("Rent.Models.User+DB", "CustomerContact")
                        .WithMany()
                    ...
                    b.HasOne("Rent.Models.User+DB", "ServiceLeader")
                        .WithMany()
