...
class _SlideDraggerState extends State<SlideDragger> {
  ...
  void _onScaleStart(ScaleStartDetails details) {
    ...
    print('2: ${(details.focalPoint - widget.slideController.buttonOffset).distance}');
  ...
  void ifDayViewElse(dayFunction, notDayFunction, details) {
    if (widget.slideController.displayMode == SlideDisplayMode.Day) {
      dayFunction(details);
    } else {
      notDayFunction(details);
    }
  }
}
