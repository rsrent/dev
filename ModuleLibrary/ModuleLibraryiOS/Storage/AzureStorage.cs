...
namespace ModuleLibraryiOS.Storage
{
    ...
    public class AzureStorage : IStorage
    {
        ...
        {
            if (upload)
                return new CloudBlobContainer(new Uri(await _credentials.GetUploadConnectionString(containerName)));
            else 
                return new CloudBlobContainer(new Uri(await _credentials.GetDownloadConnectionString(containerName)));
