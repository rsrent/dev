...
namespace ModuleLibrary.Shared.Services
{
    public static class Extensions
    {
        ...
        public static async Task<T> Put<T>(this HttpClient client, string path, object content = null, Action<T> successA = null, Action errorA = null) where T : class
        {
            return await Call<T>(client, CallType.Put, path, content, successA: successA, errorA: errorA);
        }
        ...
        private static async Task<T> Call<T>(HttpClient client, CallType callType, string path, object content = null, Action<T> successA = null, Action errorA = null, JsonConverter jsonConverter = null) where T : class
        {
            ...
            try
            {
                ...
                if (response.IsSuccessStatusCode)
                {
                    ...
                    System.Diagnostics.Debug.WriteLine("CallManager result: " + result);
                    T returnObj = null;
            ...
            {
                System.Diagnostics.Debug.WriteLine("CallManager Task<T> Call<T>");
        ...
        private static async Task Call(HttpClient client, CallType callType, string path, object content = null, Action successA = null, Action errorA = null)
        {
            ...
            {
                System.Diagnostics.Debug.WriteLine("CallManager Task Call");
                System.Diagnostics.Debug.WriteLine("CallManager error: " + ex.Message);
                System.Diagnostics.Debug.WriteLine("CallManager path: " + path);
                System.Diagnostics.Debug.WriteLine("CallManager content: " + c);
            }
